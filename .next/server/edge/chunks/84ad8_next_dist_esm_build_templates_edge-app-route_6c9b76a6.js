(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["chunks/84ad8_next_dist_esm_build_templates_edge-app-route_6c9b76a6.js",75352,e=>{"use strict";let t;var i,r=e.i(11054),a=e.i(92719),n=e.i(51615),o=e.i(19338),l=e.i(86254),s=e.i(56850),d=e.i(71727),u=e.i(24260),c=e.i(42097),p=e.i(69754),_=e.i(5453),g=e.i(64803),E=e.i(24751),m=e.i(74389),v=e.i(30721),f=e.i(69618),b=e.i(92732),R=e.i(71425);e.i(26398);var h=e.i(76555);e.i(69793);var T=e.i(74878),y=e.i(10661),k=e.i(59441);let S=(0,y.neon)(process.env.DATABASE_URL_UNPOOLED);async function N(e){if("SLN_ADMIN_2026"!==e.headers.get("x-admin-key"))return T.NextResponse.json({error:"Unauthorized"},{status:401});let t=!1!==(await e.json().catch(()=>({}))).cleanup,i={},r={bookingIds:[],batchIds:[]};try{let[e]=await S`
