module.exports=[18622,(e,t,r)=>{t.exports=e.x("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js",()=>require("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js"))},56704,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/work-async-storage.external.js",()=>require("next/dist/server/app-render/work-async-storage.external.js"))},32319,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/work-unit-async-storage.external.js",()=>require("next/dist/server/app-render/work-unit-async-storage.external.js"))},24725,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/after-task-async-storage.external.js",()=>require("next/dist/server/app-render/after-task-async-storage.external.js"))},70406,(e,t,r)=>{t.exports=e.x("next/dist/compiled/@opentelemetry/api",()=>require("next/dist/compiled/@opentelemetry/api"))},93695,(e,t,r)=>{t.exports=e.x("next/dist/shared/lib/no-fallback-error.external.js",()=>require("next/dist/shared/lib/no-fallback-error.external.js"))},41471,27308,e=>{"use strict";function t(e,t){let r=15*!!t,a=t?20:35;return{executor_pct:65,executor_amount:parseFloat((65*e/100).toFixed(2)),source_pct:r,source_amount:t?parseFloat((e*r/100).toFixed(2)):null,platform_pct:a,platform_amount:parseFloat((e*a/100).toFixed(2)),total_amount:e}}function r(e,t,r){var a;let i,s=(a=new Date(r.pickup_at),i=new Date,(a.getTime()-i.getTime())/36e5<2?90:300);return e&&e.source_driver_id?t?!function(e,t){if("active"!==e.driver_status||!e.is_eligible||!e.service_types.includes(t))return!1;let r=new Date;return!(e.license_expires_at&&new Date(e.license_expires_at)<r||e.insurance_expires_at&&new Date(e.insurance_expires_at)<r)&&!0}(t,r.service_type)?{offer_source_first:!1,source_driver_id:e.source_driver_id,timeout_secs:s,reason:`source_driver_ineligible:${t.driver_status}`}:{offer_source_first:!0,source_driver_id:t.id,timeout_secs:s,reason:"source_driver_priority"}:{offer_source_first:!1,source_driver_id:e.source_driver_id,timeout_secs:s,reason:"source_driver_not_found"}:{offer_source_first:!1,source_driver_id:null,timeout_secs:s,reason:"no_source_driver"}}function a(e){let{ref_code:t,tablet_code:r,driver_code:a,source_type:i}=e,s=i??"direct";return r?s="tablet":(t||a)&&(s="qr"),{source_type:s,ref_code:t??null,tablet_code:r??null,driver_code:a??null}}function i(e,t){return null!==e?e:t??null}e.s(["calculateCommissions",()=>t,"getDispatchStrategy",()=>r,"guardSourceDriverId",()=>i,"resolveAttribution",()=>a],41471);let s=(0,e.i(70485).neon)(process.env.DATABASE_URL);e.s(["db",0,{drivers:{findById:async e=>(await s`
    ...
    `)[0],update:async(e,t)=>{await s`
      ...
      SET
        ...
        updated_at = NOW()
      WHERE id = ${e}
    `}},bookings:{create:async e=>(await s`
    ...
    `)[0],update:async(e,t)=>{await s`
      ...
      SET
        ...
        updated_at = NOW()
      WHERE id = ${e}
    `},findById:async e=>(await s`SELECT * FROM bookings WHERE id = ${e} LIMIT 1`)[0]??null},dispatchOffers:{create:async e=>(await s`
    ...
    `)[0],confirm:async(e,t)=>{await s`
      ...
      SET
        ...
        status = 'confirmed'
      WHERE booking_id = ${e}
    `}},auditLogs:{create:async e=>{await s`
    ...
    `}},sourceSummary:{findByDriverId:async e=>(await s`
      SELECT * FROM source_driver_summary
      WHERE driver_id = ${e}
      LIMIT 1
    `)[0]??null,findAll:async()=>await s`
      SELECT * FROM source_driver_summary
      ORDER BY lifetime_source_earnings DESC
    `},leads:{create:async e=>(await s`
      INSERT INTO leads (
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c7b7c8aa._.js.map