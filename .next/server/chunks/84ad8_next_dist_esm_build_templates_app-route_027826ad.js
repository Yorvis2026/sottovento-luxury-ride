module.exports=[89386,e=>{"use strict";var t=e.i(66574),r=e.i(58350),n=e.i(10732),a=e.i(12768),i=e.i(75089),o=e.i(11299),d=e.i(66012),s=e.i(12480),c=e.i(64629),l=e.i(2078),_=e.i(99591),u=e.i(65698),b=e.i(29809),p=e.i(64157),E=e.i(56534),S=e.i(93695);e.i(22981);var A=e.i(4706),g=e.i(16770);let C=(0,e.i(70485).neon)(process.env.DATABASE_URL_UNPOOLED);async function v(e){let t=new URL(e.url).searchParams.get("view")??"active",r=["active","completed","cancelled","archived","all"].includes(t.toLowerCase().trim())?t.toLowerCase().trim():"active";try{let e;return e="active"===r?await C`
        SELECT
          b.id,
