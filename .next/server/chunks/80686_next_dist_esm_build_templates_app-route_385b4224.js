module.exports=[7746,e=>{"use strict";var t=e.i(39743),i=e.i(37383),a=e.i(16108),s=e.i(1266),n=e.i(10171),r=e.i(44067),o=e.i(7601),d=e.i(3083),l=e.i(88890),c=e.i(37886),u=e.i(63388),p=e.i(46601),_=e.i(24139),g=e.i(78785),f=e.i(2640),h=e.i(93695);e.i(46509);var N=e.i(56592),m=e.i(50974);let E=(0,e.i(57747).neon)(process.env.DATABASE_URL_UNPOOLED);async function b(e){try{let{searchParams:t}=new URL(e.url),i=t.get("code");if(!i)return m.NextResponse.json({error:"code is required"},{status:400});let a=await E`
      SELECT
        id,
        driver_code,
        full_name,
