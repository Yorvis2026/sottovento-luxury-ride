module.exports=[48421,e=>{"use strict";var t=e.i(39743),r=e.i(37383),a=e.i(16108),i=e.i(1266),o=e.i(10171),n=e.i(44067),d=e.i(7601),s=e.i(3083),l=e.i(88890),p=e.i(37886),c=e.i(63388),u=e.i(46601),g=e.i(24139),h=e.i(78785),_=e.i(2640),f=e.i(93695);e.i(46509);var y=e.i(56592),m=e.i(50974),x=e.i(57747),R=e.i(908);let b=(0,x.neon)(process.env.DATABASE_URL),v=new R.Resend(process.env.RESEND_API_KEY),E="contact@sottoventoluxuryride.com",w="SLN System <bookings@sottoventoluxuryride.com>";async function $(e){try{let{booking_id:t,driver_code:r,action:a,missing_fields:i,note:o}=await e.json();if(!t||!r||!a)return m.NextResponse.json({error:"booking_id, driver_code, and action are required"},{status:400});let n=await b`
      SELECT
