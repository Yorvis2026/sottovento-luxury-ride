module.exports=[93695,(e,t,r)=>{t.exports=e.x("next/dist/shared/lib/no-fallback-error.external.js",()=>require("next/dist/shared/lib/no-fallback-error.external.js"))},70406,(e,t,r)=>{t.exports=e.x("next/dist/compiled/@opentelemetry/api",()=>require("next/dist/compiled/@opentelemetry/api"))},18622,(e,t,r)=>{t.exports=e.x("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js",()=>require("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js"))},56704,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/work-async-storage.external.js",()=>require("next/dist/server/app-render/work-async-storage.external.js"))},32319,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/work-unit-async-storage.external.js",()=>require("next/dist/server/app-render/work-unit-async-storage.external.js"))},24725,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/after-task-async-storage.external.js",()=>require("next/dist/server/app-render/after-task-async-storage.external.js"))},82278,e=>{"use strict";var t=e.i(66574),r=e.i(58350),a=e.i(10732),o=e.i(12768),n=e.i(75089),s=e.i(11299),i=e.i(66012),c=e.i(12480),l=e.i(64629),d=e.i(2078),u=e.i(99591),_=e.i(65698),p=e.i(29809),E=e.i(64157),T=e.i(56534),N=e.i(93695);e.i(22981);var g=e.i(4706),h=e.i(16770);let R=(0,e.i(70485).neon)(process.env.DATABASE_URL_UNPOOLED);async function A(e,t,r){try{await r(),e.push({step:t,status:"ok"})}catch(a){let r=a?.message??String(a);r.includes("already exists")||r.includes("duplicate column")||r.includes("DuplicateColumn")?e.push({step:t,status:"already_exists"}):e.push({step:t,status:"error",detail:r})}}async function L(e){let t=[];await A(t,"bookings.source_reference",()=>R`ALTER TABLE bookings ADD COLUMN IF NOT EXISTS source_reference TEXT`),await A(t,"bookings.source_tablet_id",()=>R`ALTER TABLE bookings ADD COLUMN IF NOT EXISTS source_tablet_id TEXT`),await A(t,"bookings.source_campaign_id",()=>R`ALTER TABLE bookings ADD COLUMN IF NOT EXISTS source_campaign_id TEXT`),await A(t,"bookings.source_channel",()=>R`ALTER TABLE bookings ADD COLUMN IF NOT EXISTS source_channel TEXT`),await A(t,"bookings.source_metadata",()=>R`ALTER TABLE bookings ADD COLUMN IF NOT EXISTS source_metadata JSONB`),await A(t,"bookings.source_locked_at",()=>R`ALTER TABLE bookings ADD COLUMN IF NOT EXISTS source_locked_at TIMESTAMPTZ`),await A(t,"bookings.source_override_reason",()=>R`ALTER TABLE bookings ADD COLUMN IF NOT EXISTS source_override_reason TEXT`),await A(t,"bookings.source_override_timestamp",()=>R`ALTER TABLE bookings ADD COLUMN IF NOT EXISTS source_override_timestamp TIMESTAMPTZ`),await A(t,"bookings.source_override_admin_id",()=>R`ALTER TABLE bookings ADD COLUMN IF NOT EXISTS source_override_admin_id UUID`),await A(t,"create_lead_origin_snapshots",()=>R`
  ...
  `,[o]=await R`
    ...
    FROM bookings
  `,n=t.filter(e=>"error"===e.status);return h.NextResponse.json({ok:0===n.length,steps:t,errors:n.length>0?n:void 0,verification:{new_columns_present:9===Number(r.cnt),new_columns_count:Number(r.cnt),lead_origin_snapshots_exists:a.exists,backfill:{locked:Number(o.locked),unlocked:Number(o.unlocked),has_reference:Number(o.has_reference),has_channel:Number(o.has_channel),has_type:Number(o.has_type)}}})}e.s(["GET",()=>L],41995);var b=e.i(41995);let m=new t.AppRouteRouteModule({definition:{kind:r.RouteKind.APP_ROUTE,page:"/api/admin/migrate-lead-origin/route",pathname:"/api/admin/migrate-lead-origin",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/app/api/admin/migrate-lead-origin/route.ts",nextConfigOutput:"",userland:b}),{workAsyncStorage:S,workUnitAsyncStorage:k,serverHooks:U}=m;function v(){return(0,a.patchFetch)({workAsyncStorage:S,workUnitAsyncStorage:k})}async function x(e,t,a){m.isDev&&(0,o.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let h="/api/admin/migrate-lead-origin/route";h=h.replace(/\/index$/,"")||"/";let R=await m.prepare(e,t,{srcPage:h,multiZoneDraftMode:!1});if(!R)return t.statusCode=400,t.end("Bad Request"),null==a.waitUntil||a.waitUntil.call(a,Promise.resolve()),null;let{buildId:A,params:L,nextConfig:b,parsedUrl:S,isDraftMode:k,prerenderManifest:U,routerServerContext:v,isOnDemandRevalidate:x,revalidateOnlyGenerated:I,resolvedPathname:f,clientReferenceManifest:O,serverActionsManifest:w}=R,C=(0,i.normalizeAppPath)(h),D=!!(U.dynamicRoutes[C]||U.routes[f]),y=async()=>((null==v?void 0:v.render404)?await v.render404(e,t,S,!1):t.end("This page could not be found"),null);if(D&&!k){let e=!!U.routes[f],t=U.dynamicRoutes[C];if(t&&!1===t.fallback&&!e){if(b.experimental.adapterPath)return await y();throw new N.NoFallbackError}}let H=null;!D||m.isDev||k||(H="/index"===(H=f)?"/":H);let P=!0===m.isDev||!D,M=D&&!P;w&&O&&(0,s.setManifestsSingleton)({page:h,clientReferenceManifest:O,serverActionsManifest:w});let F=e.method||"GET",X=(0,n.getTracer)(),q=X.getActiveScopeSpan(),W={params:L,prerenderManifest:U,renderOpts:{experimental:{authInterrupts:!!b.experimental.authInterrupts},cacheComponents:!!b.cacheComponents,supportsDynamicResponse:P,incrementalCache:(0,o.getRequestMeta)(e,"incrementalCache"),cacheLifeProfiles:b.cacheLife,waitUntil:a.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,r,a,o)=>m.onRequestError(e,t,a,o,v)},sharedContext:{buildId:A}},j=new c.NodeNextRequest(e),B=new c.NodeNextResponse(t),K=l.NextRequestAdapter.fromNodeNextRequest(j,(0,l.signalFromNodeResponse)(t));try{let s=async e=>m.handle(K,W).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let r=X.getRootSpanAttributes();if(!r)return;if(r.get("next.span_type")!==d.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${r.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let a=r.get("next.route");if(a){let t=`${F} ${a}`;e.setAttributes({"next.route":a,"http.route":a,"next.span_name":t}),e.updateName(t)}else e.updateName(`${F} ${h}`)}),i=!!(0,o.getRequestMeta)(e,"minimalMode"),c=async o=>{var n,c;let l=async({previousCacheEntry:r})=>{try{if(!i&&x&&I&&!r)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let n=await s(o);e.fetchMetrics=W.renderOpts.fetchMetrics;let c=W.renderOpts.pendingWaitUntil;c&&a.waitUntil&&(a.waitUntil(c),c=void 0);let l=W.renderOpts.collectedTags;if(!D)return await (0,_.sendResponse)(j,B,n,W.renderOpts.pendingWaitUntil),null;{let e=await n.blob(),t=(0,p.toNodeOutgoingHttpHeaders)(n.headers);l&&(t[T.NEXT_CACHE_TAGS_HEADER]=l),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let r=void 0!==W.renderOpts.collectedRevalidate&&!(W.renderOpts.collectedRevalidate>=T.INFINITE_CACHE)&&W.renderOpts.collectedRevalidate,a=void 0===W.renderOpts.collectedExpire||W.renderOpts.collectedExpire>=T.INFINITE_CACHE?void 0:W.renderOpts.collectedExpire;return{value:{kind:g.CachedRouteKind.APP_ROUTE,status:n.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:r,expire:a}}}}catch(t){throw(null==r?void 0:r.isStale)&&await m.onRequestError(e,t,{routerKind:"App Router",routePath:h,routeType:"route",revalidateReason:(0,u.getRevalidateReason)({isStaticGeneration:M,isOnDemandRevalidate:x})},!1,v),t}},d=await m.handleResponse({req:e,nextConfig:b,cacheKey:H,routeKind:r.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:U,isRoutePPREnabled:!1,isOnDemandRevalidate:x,revalidateOnlyGenerated:I,responseGenerator:l,waitUntil:a.waitUntil,isMinimalMode:i});if(!D)return null;if((null==d||null==(n=d.value)?void 0:n.kind)!==g.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==d||null==(c=d.value)?void 0:c.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});i||t.setHeader("x-nextjs-cache",x?"REVALIDATED":d.isMiss?"MISS":d.isStale?"STALE":"HIT"),k&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let N=(0,p.fromNodeOutgoingHttpHeaders)(d.value.headers);return i&&D||N.delete(T.NEXT_CACHE_TAGS_HEADER),!d.cacheControl||t.getHeader("Cache-Control")||N.get("Cache-Control")||N.set("Cache-Control",(0,E.getCacheControlHeader)(d.cacheControl)),await (0,_.sendResponse)(j,B,new Response(d.value.body,{headers:N,status:d.value.status||200})),null};q?await c(q):await X.withPropagatedContext(e.headers,()=>X.trace(d.BaseServerSpan.handleRequest,{spanName:`${F} ${h}`,kind:n.SpanKind.SERVER,attributes:{"http.method":F,"http.target":e.url}},c))}catch(t){if(t instanceof N.NoFallbackError||await m.onRequestError(e,t,{routerKind:"App Router",routePath:C,routeType:"route",revalidateReason:(0,u.getRevalidateReason)({isStaticGeneration:M,isOnDemandRevalidate:x})},!1,v),D)throw t;return await (0,_.sendResponse)(j,B,new Response(null,{status:500})),null}}e.s(["handler",()=>x,"patchFetch",()=>v,"routeModule",()=>m,"serverHooks",()=>U,"workAsyncStorage",()=>S,"workUnitAsyncStorage",()=>k],82278)}];

//# sourceMappingURL=%5Broot-of-the-server%5D__84587eb3._.js.map