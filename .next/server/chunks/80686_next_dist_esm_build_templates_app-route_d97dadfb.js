module.exports=[89869,e=>{"use strict";var t=e.i(39743),r=e.i(37383),a=e.i(16108),o=e.i(1266),n=e.i(10171),i=e.i(44067),c=e.i(7601),s=e.i(3083),u=e.i(88890),d=e.i(37886),E=e.i(63388),_=e.i(46601),l=e.i(24139),S=e.i(78785),m=e.i(2640),p=e.i(93695);e.i(46509);var N=e.i(56592),A=e.i(50974);let C=(0,e.i(57747).neon)(process.env.DATABASE_URL_UNPOOLED??process.env.DATABASE_URL??"");async function R(e){let{searchParams:t}=new URL(e.url),r=t.get("driver_code");if(!r)return A.NextResponse.json({error:"driver_code required"},{status:400});let a=await C`
